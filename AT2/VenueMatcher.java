...
public class VenueMatcher extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        listJobRequests.setOnAction(event -> handleUserInput("1"));
        browseByCategory.setOnAction(event -> handleUserInput("2"));
        searchByName.setOnAction(event -> handleUserInput("3"));
        autoMatchEvents.setOnAction(event -> handleUserInput("4"));
        showOrderSummary.setOnAction(event -> handleUserInput("5"));
